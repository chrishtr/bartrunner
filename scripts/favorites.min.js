...
class BartRunnerFavorites {
  ...
  displayTrainStatus(trainStatus) {
    ...
    */
      ...
      let clickCallback = function() {window.location.href='details.html?'+etd.routeLabel};
      ...
      favoritesIcon.onclick = clickCallback;
      ...
      routeName.onclick = clickCallback;
      ...
      leavingBox.onclick = clickCallback;
  ...
  updateData() {
    ...
    //   {"from": "ANTC", "to": "SFIA"},
    // ]
    let favoritesData = Array.from(BartRunnerUtils.loadFavorites());

    var that = this;
    let trainStatus = [];
    let promises = favoritesData.map(function(route,indx) {
