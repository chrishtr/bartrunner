...
class BartRunner {
  ...
  requestBartApi(group,command,extraparams) {
...
window.addEventListener('load', function() {
  ...
  const bartRunnerContainer = document.getElementById('bartrunner-container');
  const bartRunner = new BartRunner(bartRunnerContainer);
});
})();
