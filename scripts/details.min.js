...
class BartRunnerDetails {
  ...
  updateTrains() {
    var that = this;
    BartRunnerUtils.requestBartApi('etd','etd',{'orig': this.fromStation.value})
      .then(function(data) {
...
window.addEventListener('load', function() {
  const obj = new BartRunnerDetails(document.getElementById('bartrunner-details-container'));
});
})();
